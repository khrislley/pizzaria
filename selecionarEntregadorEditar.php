...
<body>
    ...
    <div class="conteudo">
        <div class="selecionarEditar"><br><br>
            <form action="editarEntregador.php" name="codiEntr">
                Selecioe o entregador: <select name="codiEntr">
                    <option disabled selected>Selecione</option>
                    <?php
                    while ($umEntr = $resultadoEntregador->fetch_array()) {
                        echo "<option value='" . $umEntr["CODI_ENTR"] . "'>" . $umEntr["NOME_ENTR"] . "</option>";
                    }
                    ?>
